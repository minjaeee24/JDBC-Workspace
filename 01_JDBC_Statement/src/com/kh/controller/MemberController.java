 ...
 * 				해당 메소드로 전달된 데이터들을 가공처리(vo객체에 담아주기)한 후 Dao메소드 호출시 vo객체를 전달해준다.
...
public class MemberController {
	...
	public void insertMember(String userId, String userPwd, String userName, String gender,
		...
		// 3. result결가값에 따라서 사용자가 보게될 화면 지정
	...
	public void selectAll() {
		...
		// 조회결과가 있는지 없는지 판단 후 사용자가 보게될 VIEW화면 지정
		if(list.isEmpty()) { // 텅 빈 리스트 반환 -> 조회결과가 없다
			// 조회결과가 없을 경우 보게될 화면
